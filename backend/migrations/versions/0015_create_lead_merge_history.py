...
Revision ID: 0015_create_lead_merge_history
Revises: 0014_create_lead_audit_log
...
revision: str = "0015_create_lead_merge_history"
down_revision: Union[str, None] = "0014_create_lead_audit_log"
...
def downgrade() -> None:
    op.drop_index("ix_lead_merge_history_created_at", table_name="lead_merge_history")
    op.drop_index("ix_lead_merge_history_target_lead_id", table_name="lead_merge_history")
    op.drop_index("ix_lead_merge_history_source_lead_id", table_name="lead_merge_history")
